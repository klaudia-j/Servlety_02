...
/**
 * Servlet implementation class Session_Servlet_04
 */
@WebServlet("/Session_Servlet_04")
public class Session_Servlet_04 extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Session_Servlet_04() {
		super();
